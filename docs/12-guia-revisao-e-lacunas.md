...
- existem 13 compressores classificados neste inventário operacional;
...
- existem 12 fotos de controladores; a sexta corresponde ao COMP-09;
- existem regimes operacionais denominados -35 °C, -10 °C e -5 °C;
- os 13 compressores foram associados aos regimes, com o COMP-07 em manutenção no momento do registro;
- o COMP-09 pertence à Sala de Máquinas 2, trabalha no regime de -10 °C e é classificado operacionalmente como compressor de alta;
...
- depois da sequência dos 13 compressores classificados, a ronda segue para os recipientes/manômetros;
